...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            # Vector from 13 -> 12 (base of the hand to base of ring finger)
            vector1_x = hand_landmarks.landmark[12].x - landmark_13.x
            vector1_y = hand_landmarks.landmark[12].y - landmark_13.y

            # Vector from 13 -> 14 (base of the ring finger to first joint)
            ...
            ring_width = 60  # Adjust as necessary
            ring_height = 60  # Adjust as necessary
    ...
    cv2.imshow("Ring Finger with Ring Version 2", frame)
